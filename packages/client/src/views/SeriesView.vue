      ...
      <template #content>
        <div class="flex justify-center items-center gap-8 sm:gap-16 py-4">
          <div class="text-center">
            <div class="text-sm font-semibold text-text-secondary uppercase tracking-wide mb-1">Team 1</div>
            <div
          ...
          <div class="text-center">
            <div class="text-sm font-semibold text-text-secondary uppercase tracking-wide mb-1">Team 2</div>
            <div
              class="text-5xl sm:text-6xl font-black"
        ...
        <div class="text-center mt-2">
          <Tag v-if="s.winnerUserId" :value="s.winnerUserId === s.team1UserId ? 'Team 1 Wins!' : 'Team 2 Wins!'" severity="success" />
        </div>
      </template>
    </Card>
